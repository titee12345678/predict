...
$conn -> set_charset("utf8");
    ...
    // $sqlCheck = "SELECT * FROM model WHERE SubjectName = 'คณิตศาสตร์' AND School = '$SchoolUser'";
    ...
    //             $i++;
    //         }
    $sqlCheck = "SELECT distinct(School) FROM model WHERE SubjectName = 'คณิตศาสตร์'";
    $value = mysqli_query($conn, $sqlCheck);
    $i = 0;
            while($row = mysqli_fetch_assoc($value)) {
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 mx-auto" style="max-width: 1000px; top :130px">
                ...
                <form action="resultmath.php" method="post">
                <div class="card-header text-center">
                        <h4>พยากรณ์คะแนนวิชาคณิตศาสตร์</h4>
                    </div>
                    <div class="card-body text-left">
                        ...
                        <div class="form-group row">
                            <label for="lastname" class="col-sm-7 col-form-label"><font size="4">เกรดวิชาคณิตศาสตร์ ชั้นมัธยมศึกษาปีที่ 3 เทอมที่ 1:</font></label>
                            <div class="col-sm-5 text-right">
                            <select name="math31" required>
                                <option value="">-- เลือกเกรด --</option>
                                <option value="0">0</option>
                                <option value="1">1</option>
                                <option value="1.5">1.5</option>
                            ...
                            <!--<input type="number" min = 0.0 max = 4.0 step=0.1 name="math31" required>-->
                            </div> 
                            <hr width=96% size=7></hr>
                        </div>
                        <!-- <div class="form-group row">
                            <label for="age" class="col-sm-7 col-form-label"><font size="4">เกรดเฉลี่ยวิชาคณิตศาสตร์ 5 เทอม :</font></label>
                            <div class="col-sm-5 text-right">
                            <input type="number" min = 0.00 max = 4.00 step=0.01 name="mathtotal" required>
                            </div> 
                        </div> -->
                        <div class="form-group row">
