...
<br><br><br><br><br><br><br>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 mx-auto" style="max-width: 500px; top :110px">
                ...
                <div class="card-header text-center">
                    ...
                    <center> <h4>โปรดเข้าสู่ระบบเพื่อใช้งานการพยากรณ์และสร้างแบบจำลองโรงเรียนของท่าน</h4>
                        </div >
                            
                        <div class="card-body text-left">
                        <center><a href="login.php" class="btn btn-lg btn-danger">เข้าสู่ระบบ</a> <br><br>
                        </div >
