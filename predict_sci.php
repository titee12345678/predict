...
$conn -> set_charset("utf8");
    ...
    // $sqlCheck = "SELECT * FROM model WHERE SubjectName = 'วิทยาศาสตร์' AND School = '$SchoolUser'";
    ...
    //             $i++;
    //         }
    $sqlCheck = "SELECT distinct(School) FROM model WHERE SubjectName = 'วิทยาศาสตร์'";
    $value = mysqli_query($conn, $sqlCheck);
    $i = 0;
            while($row = mysqli_fetch_assoc($value)) {
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 mx-auto" style="max-width: 1000px; top :130px">
                ...
                <form action="resultsci.php" method="post">
                <div class="card-header text-center">
                        <h4>พยากรณ์คะแนนวิทยาศาสตร์</h4>
                    </div>
                    <div class="card-body text-left">
                        ...
                        <!-- <div class="form-group row">
                            ...
                            <div class="col-sm-5 text-right">
                            <input type="number" min = 0.00 max = 4.00 step=0.01 name="scitotal" required>
                            </div> 
                        </div> -->
                        <div class="form-group row">
